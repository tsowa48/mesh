...
create table client(id serial not null primary key, firstName text not null, lastName text not null, patronymic text, birth int not null, isMale boolean not null, address text not null, solvency real not null);
create table document(id serial not null primary key, type int not null, serial text not null, number text not null, issued int not null, issuedBy text, departmentCode int, cid int not null);
...
insert into client(firstName, lastName, patronymic, birth, isMale, address, solvency) values
  ('Иванов', 'Иван', 'Сергеевич', 4, true, 'Russia', 0.1),
  ('Petr', 'Polk', 'Chabka', 75, false, 'Russia, Kazan', 0.87);
