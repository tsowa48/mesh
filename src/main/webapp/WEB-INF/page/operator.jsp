...
<body class="container">
    ...
    <main>
        <table id="tblData" class="table table-bordered table-condensed table-hover">
            ...
            function findClient() {
                ...
                $.ajax({
                    ...
                    data.data.forEach(it => {
                        ...
                        var tr = '<tr style="cursor:pointer;" cid="'+it.id+'" class="'+clazz+'"><td>'+it.firstName+' '+it.lastName+(it.patronymic!==null?(' '+it.patronymic):'')+'</td><td>' +
